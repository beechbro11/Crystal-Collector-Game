$(document).ready(function() {
  ...
  function randomNumCrystals() {
    ...
    return {
      'red' : {
        ...
        imageUrl: "./assets/images/RedCry.png"
      },
      'blue' : {
        points: Math.floor(Math.random() * 11) + 1,
        imageUrl: "./assets/images/BlueCry.png"
      },
      'purple' : {
        points: Math.floor(Math.random() * 11) + 1,
        imageUrl: "./assets/images/PurpleCry.png"
      },
      'green' : {
        points: Math.floor(Math.random() * 11) + 1,
        imageUrl: "assets/images/GreenCry.png"
      }
    };
  }
  ...
  function updateMatchingNumber(th){
    ...
    if (self.attr('data-name') == 'red') {
      ...
      yourMatchingNumber = yourMatchingNumber + crystals[self.attr('data-name')].points;
    }else if (self.attr('data-name') == 'purple') {
      yourMatchingNumber = yourMatchingNumber + crystals[self.attr('data-name')].points;
    }else{
      yourMatchingNumber = yourMatchingNumber + crystals[self.attr('data-name')].points;
    }
